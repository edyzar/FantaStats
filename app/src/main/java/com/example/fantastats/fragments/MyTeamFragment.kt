...
class MyTeamFragment : Fragment(R.layout.fragment_my_team) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("První brankář: " + this.myPlayers?.elements?.get(0)?.firstName + " " + this.myPlayers?.elements?.get(0)?.secondName)
        println("Druhý brankář: " + this.myPlayers?.elements?.get(1)?.firstName + " " + this.myPlayers?.elements?.get(1)?.secondName)

        println("Obránce: " + this.myPlayers?.elements?.get(2)?.firstName + " " + this.myPlayers?.elements?.get(2)?.secondName)
        println("Obránce: " + this.myPlayers?.elements?.get(3)?.firstName + " " + this.myPlayers?.elements?.get(3)?.secondName)
        println("Obránce: " + this.myPlayers?.elements?.get(4)?.firstName + " " + this.myPlayers?.elements?.get(4)?.secondName)
        println("Obránce: " + this.myPlayers?.elements?.get(5)?.firstName + " " + this.myPlayers?.elements?.get(5)?.secondName)
        println("Obránce: " + this.myPlayers?.elements?.get(6)?.firstName + " " + this.myPlayers?.elements?.get(6)?.secondName)

        println("Záložník: " + this.myPlayers?.elements?.get(7)?.firstName + " " + this.myPlayers?.elements?.get(7)?.secondName)
        println("Záložník: " + this.myPlayers?.elements?.get(8)?.firstName + " " + this.myPlayers?.elements?.get(8)?.secondName)
        println("Záložník: " + this.myPlayers?.elements?.get(9)?.firstName + " " + this.myPlayers?.elements?.get(9)?.secondName)
        println("Záložník: " + this.myPlayers?.elements?.get(10)?.firstName + " " + this.myPlayers?.elements?.get(10)?.secondName)
        println("Záložník: " + this.myPlayers?.elements?.get(11)?.firstName + " " + this.myPlayers?.elements?.get(11)?.secondName)

        println("Útočník: " + this.myPlayers?.elements?.get(12)?.firstName + " " + this.myPlayers?.elements?.get(12)?.secondName)
        println("Útočník: " + this.myPlayers?.elements?.get(13)?.firstName + " " + this.myPlayers?.elements?.get(13)?.secondName)
        println("Útočník: " + this.myPlayers?.elements?.get(14)?.firstName + " " + this.myPlayers?.elements?.get(14)?.secondName)

        //println("Můj tým: " + this.myTeam)
        //println("Moji hráči: " + this.myPlayers)
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        //firstGoalie?.text = this.myPlayers?.elements?.get(0)?.firstName + this.myPlayers?.elements?.get(0)?.secondName
    ...
    private fun fillGoalies(view: View) {
        ...
        fgName?.text = this.myPlayers?.elements?.get(0)?.secondName
        ...
        fgChop?.text = this.myPlayers?.elements?.get(0)?.chanceOfPlayingNextRound.toString() + "%"

        var fgCost: TextView? =  view.findViewById(R.id.fgCost)
        fgCost?.text = this.myPlayers?.elements?.get(0)?.nowCost

        var sgName: TextView? =  view.findViewById(R.id.sgName)
        sgName?.text = this.myPlayers?.elements?.get(1)?.secondName
        ...
        sgChop?.text = this.myPlayers?.elements?.get(1)?.chanceOfPlayingNextRound.toString() + "%"

        var sgCost: TextView? =  view.findViewById(R.id.sgCost)
        sgCost?.text = this.myPlayers?.elements?.get(1)?.nowCost
    }

    private fun fillDefenders(view: View) {
        var fdName: TextView? =  view.findViewById(R.id.fdName)
        fdName?.text = this.myPlayers?.elements?.get(2)?.secondName
        ...
        fdChop?.text = this.myPlayers?.elements?.get(2)?.chanceOfPlayingNextRound.toString() + "%"

        var fdCost: TextView? =  view.findViewById(R.id.fdCost)
        fdCost?.text = this.myPlayers?.elements?.get(2)?.nowCost

        var sdName: TextView? =  view.findViewById(R.id.sdName)
        sdName?.text = this.myPlayers?.elements?.get(3)?.secondName
        ...
        sdChop?.text = this.myPlayers?.elements?.get(3)?.chanceOfPlayingNextRound.toString() + "%"

        var sdCost: TextView? =  view.findViewById(R.id.sdCost)
        sdCost?.text = this.myPlayers?.elements?.get(3)?.nowCost

        var tdName: TextView? =  view.findViewById(R.id.tdName)
        tdName?.text = this.myPlayers?.elements?.get(4)?.secondName
        ...
        tdChop?.text = this.myPlayers?.elements?.get(4)?.chanceOfPlayingNextRound.toString() + "%"

        var tdCost: TextView? =  view.findViewById(R.id.tdCost)
        tdCost?.text = this.myPlayers?.elements?.get(4)?.nowCost

        var fodName: TextView? =  view.findViewById(R.id.fodName)
        fodName?.text = this.myPlayers?.elements?.get(5)?.secondName
        ...
        fodChop?.text = this.myPlayers?.elements?.get(5)?.chanceOfPlayingNextRound.toString() + "%"

        var fodCost: TextView? =  view.findViewById(R.id.fodCost)
        fodCost?.text = this.myPlayers?.elements?.get(5)?.nowCost

        var fidName: TextView? =  view.findViewById(R.id.fidName)
        fidName?.text = this.myPlayers?.elements?.get(6)?.secondName
        ...
        fidChop?.text = this.myPlayers?.elements?.get(6)?.chanceOfPlayingNextRound.toString() + "%"

        var fidCost: TextView? =  view.findViewById(R.id.fidCost)
        fidCost?.text = this.myPlayers?.elements?.get(6)?.nowCost
    }

    private fun fillMidfielders(view: View) {
        var fmName: TextView? =  view.findViewById(R.id.fmName)
        fmName?.text = this.myPlayers?.elements?.get(7)?.secondName
        ...
        fmChop?.text = this.myPlayers?.elements?.get(7)?.chanceOfPlayingNextRound.toString() + "%"

        var fmCost: TextView? =  view.findViewById(R.id.fmCost)
        fmCost?.text = this.myPlayers?.elements?.get(7)?.nowCost

        var smName: TextView? =  view.findViewById(R.id.smName)
        smName?.text = this.myPlayers?.elements?.get(8)?.secondName
        ...
        smChop?.text = this.myPlayers?.elements?.get(8)?.chanceOfPlayingNextRound.toString() + "%"

        var smCost: TextView? =  view.findViewById(R.id.smCost)
        smCost?.text = this.myPlayers?.elements?.get(8)?.nowCost

        var tmName: TextView? =  view.findViewById(R.id.tmName)
        tmName?.text = this.myPlayers?.elements?.get(9)?.secondName
        ...
        tmChop?.text = this.myPlayers?.elements?.get(9)?.chanceOfPlayingNextRound.toString() + "%"

        var tmCost: TextView? =  view.findViewById(R.id.tmCost)
        tmCost?.text = this.myPlayers?.elements?.get(9)?.nowCost

        var fomName: TextView? =  view.findViewById(R.id.fomName)
        fomName?.text = this.myPlayers?.elements?.get(10)?.secondName
        ...
        fomChop?.text = this.myPlayers?.elements?.get(10)?.chanceOfPlayingNextRound.toString() + "%"

        var fomCost: TextView? =  view.findViewById(R.id.fomCost)
        fomCost?.text = this.myPlayers?.elements?.get(10)?.nowCost

        var fimName: TextView? =  view.findViewById(R.id.fimName)
        fimName?.text = this.myPlayers?.elements?.get(11)?.secondName
        ...
        fimChop?.text = this.myPlayers?.elements?.get(11)?.chanceOfPlayingNextRound.toString() + "%"

        var fimCost: TextView? =  view.findViewById(R.id.fimCost)
        fimCost?.text = this.myPlayers?.elements?.get(11)?.nowCost
    }

    private fun fillForwards(view: View) {
        var ffName: TextView? =  view.findViewById(R.id.ffName)
        ffName?.text = this.myPlayers?.elements?.get(12)?.secondName
        ...
        ffChop?.text = this.myPlayers?.elements?.get(12)?.chanceOfPlayingNextRound.toString() + "%"

        var ffCost: TextView? =  view.findViewById(R.id.ffCost)
        ffCost?.text = this.myPlayers?.elements?.get(12)?.nowCost

        var sfName: TextView? =  view.findViewById(R.id.sfName)
        sfName?.text = this.myPlayers?.elements?.get(13)?.secondName
        ...
        sfChop?.text = this.myPlayers?.elements?.get(13)?.chanceOfPlayingNextRound.toString() + "%"

        var sfCost: TextView? =  view.findViewById(R.id.sfCost)
        sfCost?.text = this.myPlayers?.elements?.get(13)?.nowCost

        var tfName: TextView? =  view.findViewById(R.id.tfName)
        tfName?.text = this.myPlayers?.elements?.get(14)?.secondName
        ...
        tfChop?.text = this.myPlayers?.elements?.get(14)?.chanceOfPlayingNextRound.toString() + "%"

        var tfCost: TextView? =  view.findViewById(R.id.tfCost)
        tfCost?.text = this.myPlayers?.elements?.get(14)?.nowCost
